...
Command: npx @threlte/gltf@3.0.1 cafe-rc5-ktx-transformed.glb --root /models/transformed/ --keepnames --printwidth 120 --precision 2 --draco true --preload
-->
...
<script>
  ...
  const load = () => {
    const gl = useGltf("/models/ktx2/cafe-rc5-ktx.glb", {
